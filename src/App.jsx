    ...
    tense: [
      {
        ...
        steps: [
          { t: "teach", title: "מה זה Present Simple?", body: "היי חבר! 👋 אני אגלה לך סוד: זה הזמן של דברים שקורים תמיד או כל יום — כמו לשחק כדורגל אחרי בית הספר. בוא נלמד אותו יחד!", en: "I play soccer every day", art: ["🔁", "📅", "⚽"] },
          ...
          { t: "teach", title: "הכלל הכי חשוב: s", body: "עם he, she או it מוסיפים s לפועל. עם I, you, we, they — בלי s.", en: "He plays · I play", pic: "✨" },
          ...
          { t: "teach", title: "שאלות עם Do / Does", body: "עכשיו טריק של אלופים: שאלה על he/she/it מתחילה ב-Does, וכל השאר עם Do. ואחרי Does — הפועל חוזר להיות בלי s!", en: "Does he play? · Do you play?", pic: "❓" },
          ...
          { t: "teach", title: "איזה אלוף אתה! 🎉", body: "תראה כמה למדת: הווה פשוט לדברים קבועים, s ל-he/she/it, ושאלות עם Do/Does. אני ממש גאה בך — בוא נתרגל יחד!", art: ["🏆", "⭐", "🤖"] },
        ],
      },
      {
        id: "en-past-simple", title: "Past Simple — עבר פשוט", emoji: "⏮️", min: 5,
        steps: [
          { t: "teach", title: "מה זה Past Simple?", body: "בוא נסע יחד במכונת זמן! 🚀 ככה מספרים באנגלית על משהו שכבר קרה ונגמר: אתמול, לפני שעה, או בשנה שעברה.", en: "Yesterday I played soccer", art: ["🕰️", "⬅️", "🏃"] },
          { t: "teach", title: "הכלל: מוסיפים ed", body: "ברוב הפעלים פשוט מוסיפים ed בסוף — לכל הגופים, בלי יוצאים מהכלל!", en: "play → played · jump → jumped", pic: "✨" },
          { t: "q", q: "השלם את המשפט:", en: "Last night we ___ a movie", options: ["watch", "watched", "watches", "watching"], c: 1, ex: "עבר: watch + ed = watched", pic: "🎬" },
          { t: "teach", title: "פעלים שובבים 😜", body: "יש פעלים מיוחדים שמשתנים לגמרי בעבר. את אלה פשוט זוכרים:", en: "go → went · eat → ate · see → saw", pic: "🎭" },
          ...
          { t: "teach", title: "איך מזהים שצריך עבר?", body: "מילים כמו yesterday, ago ו-last night הן רמז ענק שצריך Past Simple!", en: "yesterday · last week · an hour ago", pic: "🕵️" },
          ...
          { t: "teach", title: "כל הכבוד! 🎉", body: "עבר פשוט: ed בסוף, פעלים שובבים זוכרים, ו-yesterday מסגיר אותו. לתרגול!", pic: "🏆" },
        ],
      },
      {
        id: "en-future-will", title: "העתיד עם will", emoji: "🔮", min: 5,
        steps: [
          { t: "teach", title: "מדברים על העתיד", body: "יש לי כדור בדולח! 🔮 כשמשהו יקרה מחר או בעתיד — פשוט שמים will לפני הפועל. וזה עובד אותו דבר לכל הגופים, קל!", en: "I will win · She will win", art: ["🔮", "➡️", "🌟"] },
          { t: "q", q: "השלם את המשפט:", en: "Tomorrow I ___ visit my grandma", options: ["was", "will", "did", "am"], c: 1, ex: "מחר = עתיד: will", pic: "👵" },
          { t: "teach", title: "שלילה: won't", body: "כדי להגיד שמשהו לא יקרה: will not, ובקיצור — won't.", en: "I won't be late", pic: "🚫" },
          ...
          { t: "teach", title: "סיכום! 🎉", body: "will לפני הפועל = עתיד. won't = שלילה. שאלה מתחילה ב-Will. קדימה לתרגול!", pic: "🏆" },
        ],
      },
    ],
    sent: [
      {
        ...
        steps: [
          { t: "teach", title: "משפחת to be", body: "בוא תכיר את המשפחה הכי חשובה באנגלית! 👋 שלוש מילים קטנות — am, is, are — וכל גוף מקבל בדיוק את שלו. אחרי השיעור הזה הן יהיו חברות שלך.", en: "I am · he is · they are", art: ["👦", "👧", "👨‍👩‍👧"] },
          { t: "teach", title: "מי מקבל מה?", body: "I תמיד עם am. he, she ו-it עם is. you, we ו-they עם are.", en: "I am happy · She is happy · We are happy", pic: "🗝️" },
          ...
          { t: "teach", title: "סיכום! 🎉", body: "am–is–are זו המשפחה הכי חשובה באנגלית: I am, he is, you are. עכשיו לתרגול!", pic: "🏆" },
        ],
      },
      {
        id: "en-prepositions", title: "in / on / under — איפה זה?", emoji: "📦", min: 3,
        steps: [
          { t: "teach", title: "מילות מקום", body: "בוא נשחק במחבואים! 🙈 שלוש מילים קטנות מגלות איפה הכול מתחבא: in = בתוך, on = על, under = מתחת. תדמיין את התמונה בראש וזה יישאר איתך לתמיד!", en: "in the box · on the table · under the bed", art: ["📦", "⬆️", "⬇️"] },
          ...
          { t: "teach", title: "סיכום! 🎉", body: "in בתוך, on על, under מתחת. תמיד לדמיין את התמונה בראש! לתרגול!", pic: "🏆" },
        ],
      },
    ],
    vocab: [
      {
        ...
        steps: [
          { t: "teach", title: "צבעים באנגלית 🌈", body: "בוא נצבע את העולם יחד! 🎨 נתחיל בשלושה צבעים: red אדום, blue כחול, yellow צהוב. לחץ על המילים באנגלית ותשמע איך הן נשמעות!", en: "red · blue · yellow", art: ["🔴", "🔵", "🟡"] },
          { t: "q", q: "מה הפירוש של red?", options: ["כחול", "אדום", "צהוב", "ירוק"], c: 1, ex: "red = אדום 🔴", pic: "🔴" },
          { t: "teach", title: "עוד צבעים!", body: "green ירוק, black שחור, white לבן. טיפ: השמיים blue, הדשא green!", en: "green · black · white", pic: "🎨" },
          ...
          { t: "teach", title: "בונוס: עוד צבע יפה!", body: "עוד אחד ואתה אלוף הצבעים: purple = סגול. כמו הצבע של בִּיפּ בכפתורים! 💜", en: "purple", art: ["🟣", "💜", "🍇"] },
          { t: "q", q: "איך אומרים 'סגול' באנגלית?", options: ["purple", "pink", "orange", "brown"], c: 0, ex: "purple = סגול 🟣", pic: "🟣" },
          { t: "teach", title: "כל הכבוד! 🎉", body: "וואו, 7 צבעים באנגלית בכיס! אני גאה בך. בוא נלך לתרגול לחזק אותם יחד!", art: ["🌈", "🏆", "🤖"] },
        ],
      },
      {
        id: "en-opposites", title: "הפכים — Opposites", emoji: "↔️", min: 3,
        steps: [
          { t: "teach", title: "לכל מילה יש חבר הפוך!", body: "אני אגלה לך טריק של אלופים: מילים באות בזוגות של הפכים, כמו פיל ועכבר! ככה זוכרים שתי מילים במחיר של אחת 😉", en: "big ↔ small · hot ↔ cold", art: ["🐘", "↔️", "🐭"] },
          ...
          { t: "teach", title: "עוד זוג חשוב", body: "fast מהיר ↔ slow איטי. כמו ארנב וצב!", en: "fast ↔ slow", pic: "🐢" },
          ...
          { t: "teach", title: "מעולה! 🎉", body: "טיפ: לכל מילה חדשה — חפשו חבר הפוך. עכשיו לתרגול!", pic: "🏆" },
        ],
      },
    ],
    read: [
      {
        ...
        steps: [
          { t: "teach", title: "קוראים בלי להילחץ", body: "3 צעדים: קוראים הכול בנחת, קוראים את השאלה, וחוזרים לחפש את התשובה בטקסט.", pic: "🗺️" },
          { t: "teach", title: "בואו ננסה יחד!", body: "קראו את המשפט לאט. אפשר ללחוץ על כל מילה כדי לשמוע אותה:", en: "Tom has a small dog. The dog likes to play in the garden.", pic: "🐕" },
          ...
          { t: "teach", title: "טיפ של אלופים 🕵️", body: "לא חייבים להבין כל מילה! מחפשים את המילים המוכרות — הן בדרך כלל מספיקות לתשובה.", pic: "💡" },
          { t: "teach", title: "מוכנים! 🎉", body: "קוראים בנחת, שאלה, חוזרים לטקסט. עכשיו לתרגול קריאה אמיתי!", pic: "🏆" },
        ],
      },
    ],
  },
    ...
    add: [
      {
        ...
        steps: [
          { t: "teach", title: "הטריק של העשר 🔟", body: "אני אגלה לך את הטריק הסודי של אלופי החשבון: תמיד לעבור דרך 10! למשל 8+5: לוקחים 2 מתוך ה-5 כדי להשלים ל-10, ונשאר עוד 3. בוא ננסה יחד!", en: "8 + 5 = 8 + 2 + 3 = 13", art: ["8️⃣", "➕", "🔟"] },
          ...
          { t: "teach", title: "למה זה עובד?", body: "כי עם 10 קל לחשב! 10 ועוד משהו = פשוט מוסיפים את הספרה: 10+3=13, 10+7=17.", en: "10 + 3 = 13", pic: "💡" },
          { t: "q", q: "השלם:", en: "7 + 6 = ___", options: ["12", "14", "13", "11"], c: 2, ex: "7+3=10, נשארו עוד 3 → 13", pic: "🎯" },
          { t: "teach", title: "אלופים! 🎉", body: "תמיד לחפש את הדרך ל-10 — זה הופך כל חיבור לקל. עכשיו לתרגול!", pic: "🏆" },
        ],
      },
    ],
    sub: [
      {
        ...
        steps: [
          { t: "teach", title: "חיסור = כמה חסר?", body: "חיסור נראה מפחיד? יש לי טריק בשבילך! 🤖 במקום 12−9 פשוט שואלים: כמה צריך להוסיף ל-9 כדי להגיע ל-12? אותה תשובה — הרבה יותר קל!", en: "9 + ? = 12", art: ["9️⃣", "❓", "1️⃣2️⃣"] },
          ...
          { t: "teach", title: "הטריק של העשר גם כאן!", body: "15−8: קודם יורדים ל-10 (מורידים 5), ואז מורידים עוד 3. נשאר 7!", en: "15 − 5 − 3 = 7", pic: "🔟" },
          { t: "q", q: "השלם:", en: "13 − 7 = ___", options: ["5", "6", "7", "4"], c: 1, ex: "13−3=10, מורידים עוד 4 → 6", pic: "🎯" },
          { t: "teach", title: "כל הכבוד! 🎉", body: "חיסור = כמה חסר, ותמיד אפשר לעצור ב-10 בדרך. לתרגול!", pic: "🏆" },
        ],
      },
    ],
    mul: [
      {
        ...
        steps: [
          { t: "teach", title: "כפל = חיבור בקיצור ✖️", body: "פששש... בוא אספר לך סוד: כפל זה בכלל לא דבר חדש! 3×4 זה פשוט 4+4+4 — שלוש פעמים ארבע. כפל הוא קיצור דרך שחוסך המון פלוסים!", en: "3 × 4 = 4 + 4 + 4 = 12", art: ["🍪🍪🍪🍪", "✖️", "3️⃣"] },
          ...
          { t: "teach", title: "טריק: מותר להפוך!", body: "3×6 שווה בדיוק ל-6×3. תמיד מותר להפוך — בוחרים את הצד שקל יותר!", en: "3 × 6 = 6 × 3 = 18", pic: "🔄" },
          { t: "q", q: "אם 7×2=14, כמה זה 2×7?", options: ["12", "16", "7", "14"], c: 3, ex: "בכפל מותר להפוך — אותה תשובה!", pic: "🔄" },
          { t: "teach", title: "מעולה! 🎉", body: "כפל = חיבור חוזר, ומותר להפוך. עכשיו טבלת הכפל תהיה קלה! לתרגול!", pic: "🏆" },
        ],
      },
    ],
    div: [
      {
        ...
        steps: [
          { t: "teach", title: "חילוק = לחלק שווה בשווה", body: "דמיין: יש לך 12 סוכריות ו-3 חברים, וכולם רוצים אותו דבר בדיוק! 🍬 זה בדיוק חילוק — 12÷3, כל אחד מקבל 4. הוגן ופשוט!", en: "12 ÷ 3 = 4", art: ["🍬", "➗", "🧒🧒🧒"] },
          ...
          { t: "teach", title: "הסוד: חילוק הוא כפל הפוך!", body: "15÷3=? פשוט שואלים: 3 כפול כמה נותן 15? התשובה 5!", en: "3 × 5 = 15 → 15 ÷ 3 = 5", pic: "🔄" },
          ...
          { t: "teach", title: "אלופים! 🎉", body: "חילוק = לחלק שווה, או כפל הפוך. מי שיודע כפל — יודע גם חילוק! לתרגול!", pic: "🏆" },
        ],
      },
    ],
    frac: [
      {
        ...
        steps: [
          { t: "teach", title: "שבר = חלק משלם 🍕", body: "מי רעב? 😋 דמיין פיצה שלמה. חותכים אותה ל-2 חלקים שווים ולוקחים אחד — זה חצי (½). שבר הוא פשוט חלק ממשהו שלם!", en: "½ = 1 out of 2", art: ["🍕", "🔪", "½"] },
          { t: "q", q: "פיצה נחתכה ל-4 חלקים שווים ולקחת חלק אחד. איזה שבר אכלת?", options: ["חצי ½", "רבע ¼", "שליש ⅓", "שלם אחד"], c: 1, ex: "חלק 1 מתוך 4 = רבע", pic: "🍕" },
          { t: "teach", title: "המספר למטה קובע!", body: "המספר למטה אומר לכמה חלקים חילקנו. מחלקים ליותר — כל חלק קטן יותר! לכן ½ גדול מ-¼.", en: "½ > ¼", pic: "⚖️" },
          ...
          { t: "teach", title: "מעולה! 🎉", body: "שבר = חלק משלם, והמספר למטה אומר לכמה חילקנו. לתרגול שברים!", pic: "🏆" },
        ],
      },
    ],
    word: [
      {
        ...
        steps: [
          { t: "teach", title: "יש שיטה! 🧩", body: "בעיה בסיפור זה כמו חידת בלשים, ואני אתן לך את המפה! 🗺️ 4 צעדים: קוראים לאט, מסמנים את המספרים, שואלים 'מוסיפים או מורידים?', ופותרים. בוא נצא לדרך!", art: ["🔍", "🔢", "✅"] },
          { t: "teach", title: "מילים מסגירות!", body: "'קיבל עוד', 'ביחד', 'סך הכול' = חיבור ➕. 'נתן', 'נשאר', 'עפו' = חיסור ➖.", pic: "🕵️" },
          { t: "q", q: "לדנה 5 תפוחים 🍎 והיא קיבלה עוד 3. מה עושים?", options: ["מחסרים: 5−3", "מחברים: 5+3", "כופלים: 5×3", "מחלקים"], c: 1, ex: "'קיבלה עוד' = חיבור!", pic: "🍎" },
          { t: "q", q: "אז כמה תפוחים יש לדנה עכשיו?", options: ["7", "2", "8", "15"], c: 2, ex: "5 + 3 = 8", pic: "🍎" },
          { t: "q", q: "ליוסי היו 10 בלונים 🎈 ו-4 עפו. מה עושים?", options: ["מחברים: 10+4", "מחסרים: 10−4", "כופלים: 10×4", "שום דבר"], c: 1, ex: "'עפו' = הלכו = חיסור", pic: "🎈" },
          { t: "teach", title: "גם כפל מתחבא בסיפורים!", body: "עוד רמז של בלשים: כשכתוב 'בכל קופסה', 'לכל ילד' או 'שורות של' — כנראה מתחבא שם כפל או חילוק! 🕵️", pic: "📦" },
          ...
          { t: "teach", title: "אלופים! 🎉", body: "לקרוא לאט, לסמן מספרים, לזהות את מילת הקסם — ולפתור. לתרגול בעיות!", pic: "🏆" },
        ],
      },
    ],
  },
    ...
    story: [
      {
        ...
        steps: [
          { t: "teach", title: "קוראים כמו בלשים 🕵️", body: "היום אתה בלש ואני העוזר שלך! 🤖 בכל סיפור מתחבאות כל התשובות — קוראים לאט ומחפשים רמזים: מי? מה? איפה? מתי?", art: ["🕵️", "🔍", "📖"] },
          { t: "teach", title: "בואו ננסה!", body: "קראו את המשפט הקצר הזה בנחת:", en: "רוני הלכה עם אבא לים ביום שישי.", pic: "🏖️" },
          ...
          { t: "teach", title: "מקרה חדש לבלש! 🔎", body: "מעולה! עכשיו מקרה קצת יותר קשה. קרא לאט ושים לב לרמזים:", en: "דני מצא חתלתול קטן בגינה. הוא נתן לו צלוחית חלב.", pic: "🐈" },
          ...
          { t: "teach", title: "טיפ הזהב ✨", body: "לא בטוחים בתשובה? חוזרים לקטע ומחפשים את המילים מהשאלה — התשובה תמיד מסתתרת לידן!", pic: "💡" },
          { t: "teach", title: "מוכנים! 🎉", body: "מי, מה, איפה, מתי — ועכשיו לתרגול סיפורים אמיתי!", pic: "🏆" },
        ],
      },
    ],
  },
    ...
    animals: [
      {
        ...
        steps: [
          { t: "teach", title: "לכל חיה יש משפחה 🐾", body: "בוא נצא לספארי! 🦁 לכל חיה בעולם יש משפחה: יונקים שותים חלב אימא — כלב, פרה, וגם אנחנו! ציפורים בוקעות מביצה ויש להן נוצות וכנפיים.", art: ["🐶", "🐦", "🐟"] },
          { t: "q", q: "מי מהחיות היא יונק?", options: ["כלב", "תרנגולת", "צפרדע", "דג זהב"], c: 0, ex: "גור כלבים שותה חלב מאימא = יונק", pic: "🐶" },
          { t: "teach", title: "דגים וזוחלים", body: "דגים חיים במים ונושמים בזימים. זוחלים — נחש, לטאה וצב — זוחלים על האדמה ויש להם קשקשים.", pic: "🐍" },
          ...
          { t: "teach", title: "מעולה! 🎉", body: "יונקים, ציפורים, דגים וזוחלים — עכשיו אתה מכיר את כל המשפחות! אני גאה בך. בוא נתרגל יחד!", art: ["🐾", "🏆", "🤖"] },
        ],
      },
    ],
    plants: [
      {
        ...
        steps: [
          { t: "teach", title: "הקסם של הזרע", body: "בוא נגדל צמח יחד! 🌱 הכול מתחיל בזרע קטן באדמה. נותנים לו מים ושמש — והוא מתעורר לחיים!", art: ["🌰", "🌱", "🌻"] },
          { t: "q", q: "מה צריך הזרע כדי לנבוט?", options: ["מים ושמש", "ממתקים", "חושך בלבד", "רוח חזקה"], c: 0, ex: "מים + שמש = צמח שמח", pic: "💧" },
          { t: "teach", title: "השורש והגבעול — צוות מנצח", body: "מהזרע יוצא שורש שחופר למטה ושותה מים מהאדמה, וגבעול שמטפס למעלה אל אור השמש. עבודת צוות מושלמת!", art: ["⬇️", "🌱", "⬆️"] },
          ...
          { t: "teach", title: "כל הכבוד! 🎉", body: "מזרע קטן לפרח ענק — עכשיו אתה יודע את הסוד של הצמחים! בוא נתרגל יחד!", art: ["🌰", "➡️", "🌻"] },
        ],
      },
    ],
    body: [
      {
        ...
        steps: [
          { t: "teach", title: "יש לך מכונה מדהימה!", body: "ידעת שהגוף שלך עובד בשבילך 24 שעות ביממה? הלב שולח דם, הריאות נושמות, והמוח מנהל את הכול. בוא נכיר את הצוות!", art: ["🫀", "🫁", "🧠"] },
          { t: "q", q: "איזה איבר שולח דם לכל הגוף?", options: ["הלב", "האוזן", "הברך", "השיער"], c: 0, ex: "הלב פועם ושולח דם לכל הגוף", pic: "🫀" },
          { t: "teach", title: "המוח — המפקד", body: "המוח שלך הוא המפקד: הוא חושב, זוכר ומחליט. והנה סוד: כמו שריר, ככל שמתאמנים עליו יותר — למשל ממש עכשיו! — הוא מתחזק!", pic: "🧠" },
          ...
          { t: "teach", title: "איזה צוות! 🎉", body: "לב, ריאות ומוח — המכונה הכי משוכללת בעולם, והיא שלך! בוא נתרגל על גוף האדם!", art: ["💪", "🏆", "🤖"] },
        ],
      },
    ],
    earth: [
      {
        ...
        steps: [
          { t: "teach", title: "יוצאים לחלל!", body: "שים קסדה, אנחנו ממריאים! 👨‍🚀 כדור הארץ מסתובב סביב עצמו — וככה יש יום ולילה. והוא גם מקיף את השמש — וככה יש שנה שלמה!", art: ["🌍", "🌙", "☀️"] },
          ...
          { t: "teach", title: "הירח — השכן שלנו", body: "הירח מקיף את כדור הארץ. והנה סוד מגניב: הוא בכלל לא מאיר בעצמו! הוא כמו מראה ענקית שמחזירה את אור השמש.", pic: "🌙" },
          ...
          { t: "teach", title: "טיסה מוצלחת! 🎉", body: "יום ולילה, שנה, וירח-מראה — אתה כבר אסטרונאוט של ידע! בוא נתרגל חלל!", art: ["🚀", "🏆", "🤖"] },
        ],
      },
    ],
  },
...
function QuestionCard({ q, onAnswer, phase, selected }) {
  ...
  return (
    <div className="qcard">
      <Pic emoji={q.pic} happy={phase === "right"} />
      <div className="qtext">
